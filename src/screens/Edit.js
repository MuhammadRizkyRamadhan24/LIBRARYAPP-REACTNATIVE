...
class Edit extends Component {
    constructor(props) {
        ...
        console.log(this.props.books.dataById)
      }
            ...
            <ImageBackground source={background}  style={{flex: 1,backgroundColor: '#131212'}}>
                ...
                <View style={{flex: 9,marginHorizontal:27,justifyContent:'center'}}>
                    <Form style={{backgroundColor:'rgba(0, 0, 0, 0.5)',borderRadius:32,borderWidth:10,borderColor:'rgba(0, 0, 0, 0.5)'}}>
                        <Item last>
                            <Input defaultValue={this.props.books.dataById[0].title} onChangeText={(val) => this.setState({title: val})} style={{color: '#FFF',fontFamily: 'SanFranciscoPro',fontSize: 18}} placeholder='Title' placeholderTextColor='white'/>
                        </Item>
                        <Item last>
                        ...
                        <Item last>
                            <TextInput
                            defaultValue={this.props.books.dataById[0].description}
                        ...
                        <Button onPress={() => this.handlePostAddBook()} style={{width:'100%',backgroundColor:'#34C759',borderRadius:30, marginTop:20}} block>
                            <Text style={{fontFamily: 'SanFranciscoPro',fontSize:20,color:'#FFF' }}>Edit Book</Text>
                        </Button>
                    </Form>
                </View>
            </ImageBackground>
...
const mapDispatchToProps = { editBook, getAllAuthor, getAllGenre};
